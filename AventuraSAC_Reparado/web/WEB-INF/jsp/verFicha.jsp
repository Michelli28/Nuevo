            ...
            <div class="card" style="margin: 3% auto;" id="carta">
                <form id="formulario" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <center><h3 style="font-family: Arial; font-size: 20px;"><strong>Datos de la Prenda</strong></h3></center>
                        ...
                        <div class="row" style="text-align: left;">
                            <div class="col-sm-4">
                                ...
                                <input name="descripcion" style="background: #F0E9FF;" type="text" cssClass="form-control" placeholder="Ingresar descripcion" value="${fichatecnica.idFicha.descripcion}" />
                            </div>
                            <div class="col-sm-4">
                                <label for="idTipoModelo" >Modelo: </label>
                                <input type="text" value="${fichatecnica.idFicha.idTipoModelo.nombre}" >
                            </div>
                            <div class="col-sm-4">	
                                <label for="idTipo">Tela:</label>
                                <input type="text" value="${fichatecnica.idFicha.idTipo.nombre}" >
                            </div>
                        </div>
                        <br>
                        <div class="row" style="text-align: left;">  
                            <div class="col-sm-4"> 
                                ...
                                <input name="etiqueta" style="background: #F0E9FF;" cssClass="form-control" type="text" placeholder="Ingresar nombres de etiqueta" value="${fichatecnica.idFicha.etiqueta}"/>
                            </div>
                            <div class="col-sm-4">
                                <label for="idTalla"><strong>Talla:</strong></label>
                                <input type="text" value="${fichatecnica.idFicha.idTalla.nombre}" >
                            </div>
                            <div class="col-sm-4">
                                <label for="cantidad" >Cantidad:</label>
                                <input name="cantidad"  style="background: #F0E9FF;" type="text" cssClass="form-control" placeholder="Ingresar cantidad" value="${fichatecnica.idFicha.cantidad}"/>
                            </div>
                        </div>
                        <br>
                        <div class="row" style="text-align: left;">  
                                ...
                                <div class="card-body" id="body2">
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <div  class="p-4">
                                            ...
                                            <input name="color2" id="c2" style="height: 35px;" value="${fichatecnica.idFicha.color2}" type="text" cssClass="form-control"/>
                                        ...
                                        <div  class="p-4">
                                            ...
                                            <input name="color3" id="c3" style="height: 35px;" value="${fichatecnica.idFicha.color3}" type="text" cssClass="form-control"/>
                        ...
                        <hr style="border: 1px solid gray">
                        <center>
                            <a class="btn btn-dark" style="text-decoration: none; width: 200px; height: 50px; padding: 13px; margin: 0px 10px" href="verPedido.htm?idPedido=${fichatecnica.idPedido.idPedido}">Regresar</a>
                        </center>
